    ...
    >
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            ...
            >
              ...
              >
                Curated TUSCO gene sets for mouse tissues. Click any tissue to download the corresponding TSV file with gene annotations.
              </Typography>
            </Box>
          </motion.div>
        </Container>
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 4, md: 6 } }}>
        {loading ? (
          ...
          >
            <AnatomyMap species="mouse" tissues={tissues} />
            <TissueDownloadGrid tissues={tissues} species="mouse" />
          </motion.div>
        )}
      </Container>
    </motion.div>
